function [] = schemi_generali(G, k_range, k_step)
    ...
    title('Routh-Hurtwiz')
    axis('off')
    routh_hurtwiz = round(routh(G),2);
    uit = uitable('Data', routh_hurtwiz,'Units', 'Normalized', 'Position', sr.Position,'ColumnWidth',{30}, ColumnFormat={'rat','rat','rat','rat','rat','rat','rat','rat','rat'});
    %delete(sr)
end
...
function [rhTable, sysRoots] = routh(G)
